...
(function(factory) {
   ...
   $.fn.dateRangePicker = function(opt) {
       ...
       function showMonth(date, month) {
           ...
           box.find('.' + month + ' .month-name').html(`<div class="custom-title-daterange"><h3 class="d-flex">Chiều <p class="ml4 mr4">đi</p> <span class="mr8">Hà Nội - Huế</span></h3> ${monthElement}/${yearElement}</div>`);
